...
User Entity must implements DtoSerializableInterface
...
use Luckyseven\Bundle\LuckysevenDtoBundle\Interface\DtoSerializableInterface;

class UserDto implements DtoSerializableInterface
{
    /**
     * @Serializer\Type("int")
...
class UserDtoTransformer extends DtoTransformer {
     ...
     * @return UserDto
     */
    public function transformFromObject(DtoSerializableInterface $entity): UserDto
    {
